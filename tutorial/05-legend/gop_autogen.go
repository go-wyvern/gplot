...
//line /Users/wuxinyi/go/src/github.com/go-wyvern/gplot/tutorial/05-legend/index.plot:4
	this.Legend("sin(x)", "cos(x)")
//line /Users/wuxinyi/go/src/github.com/go-wyvern/gplot/tutorial/05-legend/index.plot:5
	this.Plot(x, y1, x, y2)
}
func main() {
